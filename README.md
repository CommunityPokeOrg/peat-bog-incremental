...
- **Fieldwork** adds two direct-action minigames: hold and release Cut peat when the charge is full, or calibrate the racks after buying a Server Rack; consecutive calibration hits raise the payout while shrinking and moving the target zone, and a miss resets the streak.
