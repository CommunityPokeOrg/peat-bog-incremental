...
export type CharterBranch = 'roots' | 'kindling' | 'filing';
...
export const CHARTER: CharterNodeDef[] = [
  { id: 'roots-1', name: 'Deep Roots', emoji: '🌿', description: 'The harvesters know where the good peat is now.', branch: 'roots', cost: 1, effects: [{ kind: 'multiplier', target: 'broth', factor: 1.25 }] },
  ...
  { id: 'kindling-1', name: 'Warm Racks', emoji: '🔥', description: 'The racks waste less heat into the courthouse.', branch: 'kindling', cost: 1, effects: [{ kind: 'heat', factor: 0.9 }] },
