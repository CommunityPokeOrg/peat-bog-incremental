...
describe('research queue', () => {
  it('enqueues research, pays costs, and rejects duplicates and a full queue', () => {
    ...
    state.wallet.evidence = D(10_000);
